...
$jscomp.findInternal = function(d, q, n) {
  ...
  for (var l = d.length, u = 0; u < l; u++) {
    var p = d[u];
    if (q.call(n, p, u, d)) return { i: u, v: p };
  }
  return { i: -1, v: void 0 };
};
$jscomp.ASSUME_ES5 = !1;
...
(function(d) {
  ...
  d.extend(t.prototype, {
    ...
    _constructor: function() {
      ...
      for (var f = 0, g = e.length; f < g; f++) this.add(e[f]);
  ...
  t.instanceSelector = function(a, b) {
    ...
    var c = [],
      ...
      f = function(a) {
        if (d.isArray(a)) for (var g = 0, k = a.length; g < k; g++) f(a[g]);
        else
          "string" === typeof a
            ? -1 !== a.indexOf(",")
              ? f(a.split(","))
      ...
      var c = [],
        ...
        f = function(a, b) {
          ...
          if (d.isArray(a) || a instanceof d)
            ...
            if (-1 !== a.indexOf(","))
              for (h = a.split(","), k = 0, g = h.length; k < g; k++)
                f(d.trim(h[k]), b);
            else if (a.match(/^\d+(\-\d+)*$/))
              ...
              for (a = a.replace(":name", ""), k = 0, g = h.length; k < g; k++)
  ...
  d.extend(r, {
    collection: {
      ...
      action: function(a, b, c, e) {
        var f = function() {
          b.buttons('[aria-haspopup="true"][aria-expanded="true"]')
            .nodes()
            .each(function() {
        ...
        if (!a) {
          ...
          if (k && "absolute" === g)
            ...
            e._collection.hasClass(e.rightAlignClassName) &&
              e._collection.css(
                "left",
                a.left + c.outerWidth() - e._collection.outerWidth()
              );
            ...
            c > d(q).width() &&
              e._collection.css("left", a.left - (c - d(q).width()));
          } else
    ...
    copy: function(a, b) {
      ...
      if (r.copyFlash && r.copyFlash.available(a, b)) return "copyFlash";
    },
    csv: function(a, b) {
  ...
  var x = function(a) {
    ...
    D = function(a, b) {
      ...
      h = h.nodes().toArray();
      for (
        var k = b.length, p = [], m = 0, n = 0, q = 0 < k ? g.length / k : 0;
        n < q;
        n++
      ) {
        for (var t = [k], r = 0; r < k; r++)
          (t[r] = c.format.body(g[m], n, r, h[m])), m++;
        p[n] = t;
      }
  ...
  d(n).on("init.dt plugin-init.dt", function(a, b) {
    "dt" === a.namespace &&
      (a = b.oInit.buttons || p.defaults.buttons) &&
      !b._buttons &&
      new t(b, a).container();
  });
