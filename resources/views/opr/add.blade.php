...
<div class="ui breadcrumb">
  ...
  <i class="right angle icon divider"></i>
  <a class="section">Barang Keluar OPR</a>
  <i class="right angle icon divider"></i>
...
<div class="ui tall stacked segment">
    ...
    <form class="ui form" action="{{ route('opr.update', ['id' => $transaksi->id]) }}" method="post">
      {{ csrf_field() }}
    ...
    <table class="ui compact celled table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $detail->note }}</td>
                <td>
                    <a href="{{ route('opr.delete_barang', ['id' => $detail->id]) }}" class="fluid ui red button">Hapus</a>
                </td>
            </tr>
            @endforeach
        </tbody>
    ...
    <br>
    <form action="{{ route('opr.selesai', ['id' => $transaksi->id]) }}" method="post">
    {{ csrf_field() }}
