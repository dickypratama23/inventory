...
<div class="ui tall stacked segment">
  ...
  <form class="ui form" action="{{ route('bap.update', ['id' => $transaksi->id]) }}" method="post">
    {{ csrf_field() }}
    ...
    <table class="ui compact celled table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $detail->note }}</td>
          <td>
            <a href="{{ route('bap.delete_barang', ['id' => $detail->id]) }}" class="fluid ui red button">Hapus</a>
          </td>
        </tr>
        @endforeach
      </tbody>
  ...
  <br>
  <form action="{{ route('bap.selesai', ['id' => $transaksi->id]) }}" method="post">
    {{ csrf_field() }}
