...
<div class="ui tall stacked segment">
    ...
    <form class="ui form" action="{{ route('transout.update', ['id' => $transaksi->id]) }}" method="post">
        {{ csrf_field() }}
        ...
        <table class="ui compact celled table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $detail->note }}</td>
                    <td>
                        <a href="{{ route('transout.delete_barang', ['id' => $detail->id]) }}"
    ...
    <br>
    <form action="{{ route('transout.selesai', ['id' => $transaksi->id]) }}" method="post">
        {{ csrf_field() }}
