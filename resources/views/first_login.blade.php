...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="user.jpg" id="icon" alt="User Icon" />
    </div>

    <!-- Login Form -->
    <form action="{{ url('/logins') }}" method="POST">
      {{ csrf_field() }}
      <input type="text" id="login" class="fadeIn second" value="{{ session('nik') }}" name="nik" placeholder="Nomor Induk Karyawan" readonly>
