...
<body>
	...
	<section>
		<div class="container">
			<div class="details clearfix">
				<div class="client left">
					<p>Penerima:</p>
                    <p class="name">{{ $service->department->kdtk }} - {{ $service->department->name }}</p>
                    <p class="name">{{ $service->pic }}</p>
				</div>
				<div class="data right">
					<div class="title">{{ $service->invoice }}</div>
					<div class="date">
						Tanggal Terima: {{ $service->created_at->format('d-m-Y') }}
					</div>
				</div>
			</div>
     ...
     @if($service->inv_relation == $service_in->invoice)
       <tr>
           ...
           <td class="desc">@if($service->detail->count() == 0) Service Biasa @else Pergantian {{ $service->detail->count() }} Spare Part @endif</td>
       </tr>
       ...
       @foreach ($service->detail as $detail)
        <tr>
           ...
           <td class="desc">Spare Part Penggantian</td>
       </tr>
      @endforeach 
	...
	<footer>
		<div class="container">
			...
			{{ $service->user->nik }} - {{ $service->user->name }}
			</div>
		</div>
		<div class="container">
